...
class FlappyBird(object):
    # Define e possibilita as alteraÃ§Ãµes de velocidades EspaÃ§amento entre Pipes
...
class Bird(object):
    ...
    def __init__(self, x, y):
        """PosiÃ§Ã£o inicial do PÃ¡ssaro Ã© descrita pelos eixos inseridos X e Y."""
        self.x = x
        self.y = y
        self.tilt = 0
        self.tick_count = 0
...
class Pipe(object):
    ...
    def collide(self, bird):
        """
        Checa colisÃ£o entre pÃ¡ssaro e a estrutura
...
def draw_window(win, birds, pipes, base, fundo, score, GEN, populacao, max_score):
    ...
    Entrada : Janela, lista de pÃ¡ssaros, lista de Pipes , base, fundo, GeraÃ§Ã£o Atual(int), PopulaÃ§Ã£o(int)
    Retorno : Nenhum
    """
    fundo.draw(win)
